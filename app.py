"""
Smart Student Placement Prediction - Main Application
"""
...
st.set_page_config(
    page_title="Smart Student Placement Prediction",
    page_icon="🚀",
    layout="wide"
)
...
class ResumeApp:
    def __init__(self):
        ...
        self.pages = {
            ...
            "📈  PLACEMENT PREDICTION ": self.render_ml_model, 
    ...
    def render_about(self):
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Smart Student Placement Prediction</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name">Manoj Kumar Chouhan</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/ManojKumarMK123" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/manoj-kumar-chouhan-1bb34a291" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:chouhanmanojmk123@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning. 
                    I created Smart Student Placement Prediction to revolutionize how job seekers approach their career journey. 
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Smart Student Placement Prediction represents my vision of democratizing career advancement through technology. 
        ...
        """, unsafe_allow_html=True)
    # def Predictor(CGPA,Internships, Projects, Certifications, AptitudeTestScore, SoftSkillsRating, ExtracurricularActivities, PlacementTraining, SSC_Marks, HSC_Marks):
    #     probability = 0
    #     if(CGPA>7.6):
    ...
    def render_ml_model(self):
        apply_modern_styles()
        page_header(
            "Smart Student Placement Prediction",
            "Predict Your Placement Success Instantly"
        )
        ...
        def Predictor(CGPA,Internships, Projects, Certifications, AptitudeTestScore, SoftSkillsRating, ExtracurricularActivities, PlacementTraining, SSC_Marks, HSC_Marks):
            ...
            if(CGPA>7.5):
                probability+=(CGPA/100)
            if (AptitudeTestScore>=70):
                probability+=(AptitudeTestScore/1000)
            if SoftSkillsRating>3.9:
                probability+=(SoftSkillsRating*2/100)*2
            if Projects>=3:
                probability+=(0.1)
            elif Projects==2:
                probability+=0.07
            ...
            if PlacementTraining=='Yes' or PlacementTraining==1:
                probability+=0.1
            if HSC_Marks>=60:
                probability+=(HSC_Marks/1000)/2
            if SSC_Marks>=60:
                probability+=(SSC_Marks/1000)/2
            if probability>=0.7:
                return [True,probability]
            else:
                return [False,probability]
        ...
        def save_prediction(data, filename='placement_predictions.xlsx'):
    ...
    # Prepare input array
            ...
            if not is_valid_email(Email):
                ...
                user_data = {
                    ...
                    "Soft Skills Rating": SoftSkillsRating,
                    "Extracurricular Activities": ExtracurricularActivities,
                    "Placement Training": PlacementTraining,
                    "SSC Marks": SSC_Marks,
                    "HSC Marks": HSC_Marks,
    ...
    def render_feedback_page(self):
        ...
        st.markdown("""
            <div class="feedback-header">
                ...
                <p>Help us improve Smart Student Placement Prediction with your valuable feedback</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    def render_home(self):
        ...
        hero_section(
            "Smart Student Placement Prediction",
            "Transform your career with AI-powered resume analysis. Get personalized insights and get the probabilty of your placement by analysing your skills, academics and experience."
        )
        ...
        feature_card(
            "fas fa-magic",
            "Smart Student Placement Prediction",
            "Get personalized insights and get the probabilty of your placement by analysing your skills, academics and experience."
        )
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            st.title("Smart Student Placement Prediction")
            st.markdown("---")
